        ...
        <main className="min-h-screen bg-white font-sans selection:bg-[#6bc4bb] selection:text-white">
            ...
            <section className="pt-24 pb-16 px-6 max-w-[1200px] mx-auto text-center relative">
                ...
                >
                    ...
                    <h1 className="text-[40px] md:text-[54px] font-extrabold text-[#3a4454] leading-[1.1] mb-6 tracking-tight">
                        Your clients, known <br />
                        <span className="relative inline-block"><span className="relative z-10">better than ever</span><span className="absolute bottom-1 left-0 w-full h-3 bg-[#e0efec] -z-0"></span></span>
                    </h1>
                    <p className="text-[#6b7280] text-[18px] md:text-[20px] font-medium max-w-2xl mx-auto mb-10 leading-relaxed">
                        Give every customer a VIP experience. With centralized client profiles, you have their preferences, history, and notes at your fingertips before they even walk through the door.
                    </p>
                    <button
            ...
            <section className="relative px-6 mb-32 pt-16 mt-8">
                ...
                <div className="max-w-[1100px] mx-auto relative z-10 flex flex-col md:flex-row items-center justify-center">
                    ...
                    >
                        <p className="text-[#f88863] text-sm font-bold uppercase tracking-wider mb-2">Comprehensive Profiles</p>
                        <h2 className="text-[28px] md:text-[34px] font-extrabold text-[#3a4454] leading-[1.15] mb-4 tracking-tight">
                            Everything stored in one unified file
                        </h2>
                        <p className="text-[#6b7280] text-[16px] leading-relaxed font-medium">
                            Color formulas, allergies, preferred drinks, and past appointment history. Easily access and update their profile directly from your smartphone or iPad at the chair.
                        </p>
                    </motion.div>
            ...
            <section className="py-24 bg-white px-6">
                <div className="max-w-[800px] mx-auto text-center">
                    ...
                    >
                        <p className="text-[#6bc4bb] text-sm font-bold uppercase tracking-wider mb-2">Visual Gallery</p>
                        ...
                        <p className="text-[#6b7280] text-[17px] leading-relaxed font-medium">
                            Snap a picture of their fresh haircut or nail design and upload it directly into their file. Build a comprehensive visual history of their transformations directly tied to their visits.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="py-32 bg-[#f4f6f8] px-6">
                <div className="max-w-[1000px] mx-auto flex flex-col md:flex-row items-center gap-12">
                    <motion.div
                        ...
                        className="flex-1"
                    >
                        <p className="text-[#f88863] text-sm font-bold uppercase tracking-wider mb-2">Digital Forms</p>
                        <h2 className="text-[32px] md:text-[40px] font-extrabold text-[#3a4454] leading-[1.1] mb-6 tracking-tight">
                            Automated Data Collection
                        </h2>
                        <p className="text-[#6b7280] text-[17px] leading-relaxed font-medium">
                            Send consultation forms or digital waivers automatically when a client books online. Have them fill and sign documents from their own device before they even arrive at the salon.
                        </p>
                    </motion.div>
            ...
            <section className="py-32 bg-white px-6">
                <div className="max-w-[800px] mx-auto text-center">
                    <motion.div
                        ...
                        transition={{ duration: 0.7 }}
                    >
                        <p className="text-[#4b6dcb] text-sm font-bold uppercase tracking-wider mb-2">Loyalty Programs</p>
                        <h2 className="text-[32px] md:text-[40px] font-extrabold text-[#3a4454] leading-[1.1] mb-6 tracking-tight">
                            Automated loyalty points
                        </h2>
                        <p className="text-[#6b7280] text-[17px] leading-relaxed font-medium">
                            No more physical punch cards. Clients automatically earn points based on their spending rules set by you. The POS intuitively alerts your staff when a client is eligible for a reward during checkout.
                        </p>
                    </motion.div>
                </div>
            </section>
            ...
            <section className="bg-white border-t border-neutral-100">
                <div className="flex flex-col md:flex-row items-stretch">
                    ...
                    <div className="flex-1 bg-[#f4f6f8] flex flex-col justify-center gap-6 py-24 px-6 md:px-12 lg:px-24">
                        <motion.a
                            href="/professionals/features/employee-management"
                        ...
                        >
                            ...
                            <div>
                                <h4 className="font-bold text-[#3a4454] mb-1 group-hover:text-[#6bc4bb] transition-colors">Employee management</h4>
                                <p className="text-sm text-neutral-500 font-medium">Keep track of schedules, breaks, and calculate commissions accurately.</p>
                            </div>
                        </motion.a>
                        <motion.a
