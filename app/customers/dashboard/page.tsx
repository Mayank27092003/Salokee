...
export default function DashboardOverviewPage() {
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-extrabold text-neutral-800 tracking-tight">Welcome back, Sarah! 👋</h1>
                <p className="text-neutral-500 mt-2 text-lg">Here is an overview of your beauty & wellness schedule.</p>
            </div>
            ...
            <div className="bg-white rounded-3xl shadow-sm border border-neutral-100 overflow-hidden">
                <div className="border-b border-neutral-100 p-6 flex items-center justify-between">
                    <h2 className="text-xl font-bold text-neutral-800">Your Next Appointment</h2>
